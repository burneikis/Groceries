...
export default function ItemRow({ item }) {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 border-t border-gray-50 group">
      ...
      <div
        className={`flex-1 min-w-0 cursor-pointer ${isChecked ? 'opacity-50' : ''}`}
      ...
      <button
        ...
        className="opacity-0 group-hover:opacity-100 sm:opacity-0 max-sm:opacity-100 p-1 text-gray-300 hover:text-red-400 active:text-red-400 transition-all"
      >
